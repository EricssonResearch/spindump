...
traces="trace_icmpv4_short trace_icmpv6_short trace_tcp_short trace_tcp_short_json trace_dns trace_quic_v18_short_spin trace_quic_v18_short_spin_all trace_quic_v18_long_spin trace_quic_v18_long_spin_all trace_quic_v19_short_quant trace_quic_v20_medium_quant trace_quic_fail1_quant trace_quic_fail2_quant trace_quic_google trace_quic_bug_ls trace_tunnel_interface_ping trace_tcp_medium_snap80 trace_tcp_large_snap80"
