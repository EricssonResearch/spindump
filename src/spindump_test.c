...
unittests_table(void) {
  ...
  struct spindump_connectionstable* table = spindump_connectionstable_initialize(1000000,0);
  spindump_checktest(table != 0);
  spindump_connectionstable_uninitialize(table);
  table = spindump_connectionstable_initialize(1000000,0);
  spindump_checktest(table != 0);
...
systemtests(void) {
  ...
  struct spindump_analyze* analyzer = spindump_analyze_initialize(0,1000000,0);
